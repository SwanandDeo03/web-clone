...
if (!document.querySelector('#slide-out-styles')) {
    document.head.insertAdjacentHTML('beforeend', slideOutStyles.replace('<style>', '<style id="slide-out-styles">'));
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    socialLinks.forEach(link => {
        link.addEventListener('click', function(e) {
            ...
            showNotification(`Opening ${platform.includes('github') ? 'GitHub' : 
                                           platform.includes('linkedin') ? 'LinkedIn' : 
                                           platform.includes('twitter') ? 'Twitter' : 
                                           platform.includes('instagram') ? 'Instagram' : 'social media'}`, 'info');
        });
    });
});
